...
def create_sampler_and_steps_selection(choices, tabname):
    if opts.samplers_in_dropdown:
        with FormRow(elem_id=f"sampler_selection_{tabname}"):
            ...
            steps = gr.Slider(minimum=1, maximum=1500, step=1, elem_id=f"{tabname}_steps", label="Sampling steps", value=200)
    else:
            ...
            with gr.Column(variant='compact', elem_id="txt2img_settings"):
                ...
                for category in ordered_ui_categories():
                    if category == "sampler":
                        ...
                        cfg_scale = gr.Slider(minimum=1.0, maximum=300.0, step=0.5, label='CFG Scale', value=70.0, elem_id="txt2img_cfg_scale")
                        ...
                        with FormGroup(visible=False, elem_id="txt2img_hires_fix") as hr_options:
                            with FormRow(elem_id="txt2img_hires_fix_row1", variant="compact"):
                                ...
                                hr_second_pass_steps = gr.Slider(minimum=0, maximum=1500, step=1, label='Hires steps', value=0, elem_id="txt2img_hires_steps")
            ...
            with gr.Column(variant='compact', elem_id="img2img_settings"):
                ...
                for category in ordered_ui_categories():
                    if category == "sampler":
                        ...
                        with FormGroup():
                            with FormRow():
                                cfg_scale = gr.Slider(minimum=1.0, maximum=300.0, step=0.5, label='CFG Scale', value=70.0, elem_id="img2img_cfg_scale")
