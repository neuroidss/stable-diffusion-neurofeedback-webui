...
options_templates.update(options_section(('optimizations', "Optimizations"), {
    ...
    "attention_type": OptionInfo("Default", "attention_type", gr.Dropdown, lambda: {"choices": ["Default"] + ["Random"] + ["Coherence"]}),
    "coherence_json": OptionInfo("{}", 'coherence_json'),
    "random_attention_mask_scale": OptionInfo(1, "random_attention_mask_scale", gr.Number, {"precision": 0}),
    "random_attention_mask_seed": OptionInfo(-1, "random_attention_mask_seed", gr.Number, {"precision": 0}),    
